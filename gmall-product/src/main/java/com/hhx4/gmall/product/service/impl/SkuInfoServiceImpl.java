...
import com.hhx4.gmall.product.vo.SeckillInfoVo;
...
import com.hhx4.gmall.product.dao.SkuInfoDao;
...
public class SkuInfoServiceImpl extends ServiceImpl<SkuInfoDao, SkuInfoEntity> implements SkuInfoService {
    ...
    public SkuItemVo item(Long skuId) throws InterruptedException, ExecutionException {
        ...
        //等到所有任务都完成
        CompletableFuture.allOf(saleAttrFuture,descFuture,baseAttrFuture).get();
